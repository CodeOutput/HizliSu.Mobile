...
class ProductDetailPage extends StatelessWidget {
  ...
  Widget body(BuildContext context) {
    return GestureDetector(
      ...
      child: GetX<HomePageModel>(initState: (state) async {
        SchedulerBinding.instance.addPostFrameCallback((_) async {
          await homePageCtrl.getProductDetail(productId);
        });
      }, builder: (_) {
        cartQuantity.value = _.getQuantity(_.product.value.id);
                              ...
                              child: Column(
                                children: [
                                  ...
                                  ListTile(
                                    ...
                                    title: Text("Adet"),
                                    trailing: Text(
                                        "x${_.product.value.unitQuantity}"),
                                  ),
                                  Divider(
                                    height: 1,
                                    color: Colors.grey,
  ...
  void _updateCart({bool increase, int quantity}) async {
    ...
    var cartItem = new CartItemModel(product: homePageCtrl.product.value, cartQuantity: newQuantity);
